  ...
  return (
    <div className="group relative">
      ...
      <Handle
        ...
        className="-left-2! h-3.5! w-3.5! border-2! border-primary! bg-base-100! transition-all hover:scale-125"
      />
      ...
      <Handle
        ...
        id="source-default"
        className={cn(
          '-right-2! h-3.5! w-3.5! border-2! border-primary! bg-base-100! transition-all hover:scale-125',
      ...
      <Handle
        ...
        id="source-success"
        className={cn(
          '-right-2! top-[40%]! h-3.5! w-3.5! border-2! border-success! bg-base-100! transition-all hover:scale-125',
          !data.enableErrorHandling && 'pointer-events-none! opacity-0!'
        )}
      />
      ...
      <Handle
        ...
        id="source-failure"
        className={cn(
          '-right-2! top-[70%]! h-3.5! w-3.5! border-2! border-error! bg-base-100! transition-all hover:scale-125',
          !data.enableErrorHandling && 'pointer-events-none! opacity-0!'
        )}
      />
      ...
      >
        <button
          ...
          className={cn(
            ...
            showBranchSelector && 'scale-110 border-primary bg-primary text-primary-content'
          )}
